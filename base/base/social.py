...
def create_user_with_profile_picture(strategy, details, backend, user=None, response=None, *args, **kwargs):
    ...
    if backend.name == 'google-oauth2':
        try:
            ...
            user = CustomUser.objects.create_user(username=username, email=email, password=None, first_name=first_name, last_name=last_name, profile_picture_url=profile_picture_url)
