...
window.requestsGET = function (url, headers = {}, callback, useFetch = false) {
  let startTime = new Date();
  ...
  if (useFetch) {
      ...
      // Use XHR
      var xhr = new XMLHttpRequest();
      xhr.open('GET', url, true); // Always async
      Object.keys(headers).forEach(key => xhr.setRequestHeader(key, headers[key]));
      xhr.onload = function () {
          if (xhr.status >= 200 && xhr.status < 300) {
              let endTime = new Date();
...
window.verifyHcaptcha = function (token, successCallback, errorCallback) {
  const url = '/verify-hcaptcha';
  const headers = { };
...
window.getAllTemplates = function(successCallback, errorCallback) {
  let url = '/tools/get-templates/?' + new Date().getTime();
  let headers = {
    'Cache-Control': 'no-cache, no-store, must-revalidate',
    'Pragma': 'no-cache',
    'Expires': '0',
...
window.getAllAutoleadsApps = function (successCallback, errorCallback) {
  const url = '/autoleads/creator/get-or-set-all-apps';
  const headers = {
    'Accept': 'application/json',
    'Content-Type': 'application/json',
  };
...
window.setAllAutoleadsApps = function (apps, successCallback, errorCallback) {
  const url = '/autoleads/creator/get-or-set-all-apps';
  const headers = {
    'Accept': 'application/json',
  };
...
window.forceRestartAutoleadsApps = function (successCallback, errorCallback) {
  const url = '/autoleads/creator/force-restart-to-app';
  const headers = {
    'Content-Type': 'application/json',
  };
  const formData = new FormData();
...
window.getInfoFromApp = function (successCallback, errorCallback) {
  const url = '/autoleads/creator/get-info-from-app';
  const headers = {
    'Accept': 'application/json',
    'Content-Type': 'application/json',
  };
...
window.forceStartAutoleadsApps = function (successCallback, errorCallback) {
  const url = '/autoleads/creator/force-start-to-app';
  const headers = {
    'Content-Type': 'application/json',
  };
  const formData = new FormData();
