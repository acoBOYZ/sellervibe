...
cb_2.addEventListener("click", function(){
  ...
  const inner_r_2_2 = '<label class="label"><span class="label-text">Type or copy and paste contacts</span></label><textarea id="emailList" class="textarea textarea-bordered textarea-sm w-full h-24 focus:outline-none" placeholder="email1, email2, ..."></textarea>';
